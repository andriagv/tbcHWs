...
final class ViewController: UIViewController {
    ...
    private var numberContingLable = ""  //new
    ...
    lazy private var buttonPercent = createButton(image: UIImage(named: "percentLight"))
    lazy private var buttonDivide = createButton(image: UIImage(named: "divideSvg"))
    lazy private var buttonMultiple = createButton(image: UIImage(named: "multipleLight"))
    lazy private var buttonIncrement = createButton(image: UIImage(named: "incrementLight"))
    lazy private var buttonDecrement = createButton(image: UIImage(named: "decrementLight"))
    ...
    private func configureHistoryButton() {   //new შევქმენით გადასასვლელი ღილაკი
...
//            }
    ...
    // ტოლობის ღილაკს რო დავაჭერთ თითს მაშინ რა მოხდება
